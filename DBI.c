...
XS(XS_DBI__setup_handle)
{
    dXSARGS;
    if (items != 4)
	Perl_croak(aTHX_ "Usage: DBI::_setup_handle(sv, imp_class, parent, imp_datasv)");
    {
	SV *	sv = ST(0);
...
XS(XS_DBI__handles)
{
    dXSARGS;
    if (items != 1)
	Perl_croak(aTHX_ "Usage: DBI::_handles(sv)");
    SP -= items;
    {
	SV *	sv = ST(0);
#line 2759 "DBI.xs"
...
XS(XS_DBI_neat)
{
    dXSARGS;
    if (items < 1 || items > 2)
	Perl_croak(aTHX_ "Usage: DBI::neat(sv, maxlen=0)");
    {
	SV *	sv = ST(0);
	U32	maxlen;
...
XS(XS_DBI_hash)
{
    dXSARGS;
    if (items < 1 || items > 2)
	Perl_croak(aTHX_ "Usage: DBI::hash(key, type=0)");
    {
...
XS(XS_DBI__install_method)
{
    dXSARGS;
    if (items < 3 || items > 4)
	Perl_croak(aTHX_ "Usage: DBI::_install_method(class, meth_name, file, attribs=Nullsv)");
    {
...
XS(XS_DBI_trace)
{
    ...
    dXSI32;
    if (items < 1 || items > 3)
       Perl_croak(aTHX_ "Usage: %s(sv, level=-1, file=Nullsv)", GvNAME(CvGV(cv)));
    {
	SV *	sv = ST(0);
	int	level;
	SV *	file;
...
XS(XS_DBI_dump_handle)
{
    dXSARGS;
    if (items < 1 || items > 3)
	Perl_croak(aTHX_ "Usage: DBI::dump_handle(sv, msg=\"DBI::dump_handle\", level=0)");
    {
	SV *	sv = ST(0);
	char *	msg;
	int	level;
...
XS(XS_DBD_____db_preparse)
{
    dXSARGS;
    if (items < 4 || items > 5)
	Perl_croak(aTHX_ "Usage: DBD::_::db::preparse(dbh, statement, ps_accept, ps_return, foo=Nullch)");
    {
	SV *	dbh = ST(0);
...
XS(XS_DBD_____st__set_fbav)
{
    dXSARGS;
    if (items != 2)
	Perl_croak(aTHX_ "Usage: DBD::_::st::_set_fbav(sth, src_rv)");
    {
	SV *	sth = ST(0);
	SV *	src_rv = ST(1);
#line 3030 "DBI.xs"
...
XS(XS_DBD_____st_bind_col)
{
    dXSARGS;
    if (items < 3 || items > 4)
	Perl_croak(aTHX_ "Usage: DBD::_::st::bind_col(sth, col, ref, attribs=Nullsv)");
    {
	SV *	sth = ST(0);
	SV *	col = ST(1);
	SV *	ref = ST(2);
...
XS(XS_DBD_____st_fetchrow_hashref)
{
    dXSARGS;
    if (items < 1 || items > 2)
	Perl_croak(aTHX_ "Usage: DBD::_::st::fetchrow_hashref(sth, keyattrib=Nullch)");
    {
	SV *	sth = ST(0);
	char *	keyattrib;
#line 3145 "DBI.xs"
...
XS(XS_DBD_____common_STORE)
{
    dXSARGS;
    if (items != 3)
	Perl_croak(aTHX_ "Usage: DBD::_::common::STORE(h, keysv, valuesv)");
    {
	SV *	h = ST(0);
	SV *	keysv = ST(1);
	SV *	valuesv = ST(2);
...
XS(XS_DBD_____common_FETCH)
{
    dXSARGS;
    if (items != 2)
	Perl_croak(aTHX_ "Usage: DBD::_::common::FETCH(h, keysv)");
    {
	SV *	h = ST(0);
	SV *	keysv = ST(1);
#line 3270 "DBI.xs"
...
XS(XS_DBD_____common_event)
{
    dXSARGS;
    if (items < 2 || items > 4)
	Perl_croak(aTHX_ "Usage: DBD::_::common::event(h, type, a1=&sv_undef, a2=&sv_undef)");
    {
	SV *	h = ST(0);
...
XS(XS_DBD_____common_set_err)
{
    dXSARGS;
    if (items < 2 || items > 6)
	Perl_croak(aTHX_ "Usage: DBD::_::common::set_err(h, errval, errstr=&sv_no, state=&sv_undef, method=&sv_undef, result=Nullsv)");
    {
	SV *	h = ST(0);
	SV *	errval = ST(1);
	SV *	errstr;
...
XS(XS_DBD_____common_trace)
{
    ...
    dXSI32;
    if (items < 1 || items > 3)
       Perl_croak(aTHX_ "Usage: %s(h, level=0, file=Nullsv)", GvNAME(CvGV(cv)));
    {
	SV *	h = ST(0);
	int	level;
	SV *	file;
...
XS(boot_DBI)
{
...

    {
        ...
        cv = newXS("DBI::SQL_ARRAY_LOCATOR", XS_DBI_constant, file);
        XSANY.any_i32 = SQL_ARRAY_LOCATOR ;
        sv_setpv((SV*)cv, "") ;
        cv = newXS("DBI::DBIpp_cm_cs", XS_DBI_constant, file);
        XSANY.any_i32 = DBIpp_cm_cs ;
        sv_setpv((SV*)cv, "") ;
        cv = newXS("DBI::SQL_UDT_LOCATOR", XS_DBI_constant, file);
        XSANY.any_i32 = SQL_UDT_LOCATOR ;
        sv_setpv((SV*)cv, "") ;
        cv = newXS("DBI::SQL_CLOB_LOCATOR", XS_DBI_constant, file);
        ...
        sv_setpv((SV*)cv, "") ;
        cv = newXS("DBI::DBIpp_st_qq", XS_DBI_constant, file);
        XSANY.any_i32 = DBIpp_st_qq ;
        sv_setpv((SV*)cv, "") ;
        cv = newXS("DBI::SQL_BOOLEAN", XS_DBI_constant, file);
        XSANY.any_i32 = SQL_BOOLEAN ;
        sv_setpv((SV*)cv, "") ;
        cv = newXS("DBI::SQL_WCHAR", XS_DBI_constant, file);
        XSANY.any_i32 = SQL_WCHAR ;
        sv_setpv((SV*)cv, "") ;
        cv = newXS("DBI::DBIpp_st_bs", XS_DBI_constant, file);
        ...
        sv_setpv((SV*)cv, "") ;
        cv = newXS("DBI::SQL_INTERVAL_HOUR_TO_MINUTE", XS_DBI_constant, file);
        XSANY.any_i32 = SQL_INTERVAL_HOUR_TO_MINUTE ;
        sv_setpv((SV*)cv, "") ;
        cv = newXS("DBI::SQL_INTERVAL_DAY_TO_HOUR", XS_DBI_constant, file);
        XSANY.any_i32 = SQL_INTERVAL_DAY_TO_HOUR ;
        sv_setpv((SV*)cv, "") ;
        cv = newXS("DBI::SQL_INTERVAL", XS_DBI_constant, file);
        XSANY.any_i32 = SQL_INTERVAL ;
        sv_setpv((SV*)cv, "") ;
        cv = newXS("DBI::SQL_FLOAT", XS_DBI_constant, file);
        XSANY.any_i32 = SQL_FLOAT ;
        sv_setpv((SV*)cv, "") ;
        cv = newXS("DBI::SQL_UDT", XS_DBI_constant, file);
        XSANY.any_i32 = SQL_UDT ;
        sv_setpv((SV*)cv, "") ;
        cv = newXS("DBI::SQL_INTERVAL_YEAR", XS_DBI_constant, file);
        XSANY.any_i32 = SQL_INTERVAL_YEAR ;
        sv_setpv((SV*)cv, "") ;
        cv = newXS("DBI::SQL_INTERVAL_HOUR_TO_SECOND", XS_DBI_constant, file);
        XSANY.any_i32 = SQL_INTERVAL_HOUR_TO_SECOND ;
        sv_setpv((SV*)cv, "") ;
        cv = newXS("DBI::SQL_INTERVAL_HOUR", XS_DBI_constant, file);
        ...
        sv_setpv((SV*)cv, "") ;
        cv = newXS("DBI::SQL_INTERVAL_MINUTE_TO_SECOND", XS_DBI_constant, file);
        ...
        sv_setpv((SV*)cv, "") ;
        cv = newXS("DBI::DBIpp_cm_dw", XS_DBI_constant, file);
        XSANY.any_i32 = DBIpp_cm_dw ;
        sv_setpv((SV*)cv, "") ;
        cv = newXS("DBI::SQL_TYPE_TIME_WITH_TIMEZONE", XS_DBI_constant, file);
        ...
        sv_setpv((SV*)cv, "") ;
        cv = newXS("DBI::DBIpp_cm_XX", XS_DBI_constant, file);
        XSANY.any_i32 = DBIpp_cm_XX ;
        sv_setpv((SV*)cv, "") ;
        cv = newXS("DBI::SQL_TYPE_TIMESTAMP", XS_DBI_constant, file);
        XSANY.any_i32 = SQL_TYPE_TIMESTAMP ;
        sv_setpv((SV*)cv, "") ;
        cv = newXS("DBI::SQL_INTERVAL_DAY_TO_MINUTE", XS_DBI_constant, file);
        XSANY.any_i32 = SQL_INTERVAL_DAY_TO_MINUTE ;
        sv_setpv((SV*)cv, "") ;
        cv = newXS("DBI::SQL_TYPE_DATE", XS_DBI_constant, file);
        XSANY.any_i32 = SQL_TYPE_DATE ;
        sv_setpv((SV*)cv, "") ;
        cv = newXS("DBI::SQL_BLOB", XS_DBI_constant, file);
        XSANY.any_i32 = SQL_BLOB ;
        sv_setpv((SV*)cv, "") ;
        cv = newXS("DBI::constant", XS_DBI_constant, file);
        XSANY.any_i32 = 0 ;
        sv_setpv((SV*)cv, "") ;
        cv = newXS("DBI::SQL_BLOB_LOCATOR", XS_DBI_constant, file);
        XSANY.any_i32 = SQL_BLOB_LOCATOR ;
        sv_setpv((SV*)cv, "") ;
        cv = newXS("DBI::SQL_INTERVAL_DAY", XS_DBI_constant, file);
        XSANY.any_i32 = SQL_INTERVAL_DAY ;
        sv_setpv((SV*)cv, "") ;
        cv = newXS("DBI::SQL_INTERVAL_DAY_TO_SECOND", XS_DBI_constant, file);
        XSANY.any_i32 = SQL_INTERVAL_DAY_TO_SECOND ;
        sv_setpv((SV*)cv, "") ;
        cv = newXS("DBI::SQL_INTERVAL_YEAR_TO_MONTH", XS_DBI_constant, file);
        XSANY.any_i32 = SQL_INTERVAL_YEAR_TO_MONTH ;
        sv_setpv((SV*)cv, "") ;
        cv = newXS("DBI::SQL_INTERVAL_MONTH", XS_DBI_constant, file);
        XSANY.any_i32 = SQL_INTERVAL_MONTH ;
        sv_setpv((SV*)cv, "") ;
        cv = newXS("DBI::SQL_CLOB", XS_DBI_constant, file);
        XSANY.any_i32 = SQL_CLOB ;
        sv_setpv((SV*)cv, "") ;
        cv = newXS("DBI::SQL_GUID", XS_DBI_constant, file);
        XSANY.any_i32 = SQL_GUID ;
        sv_setpv((SV*)cv, "") ;
        cv = newXS("DBI::SQL_REF", XS_DBI_constant, file);
        XSANY.any_i32 = SQL_REF ;
        sv_setpv((SV*)cv, "") ;
        cv = newXS("DBI::SQL_DATETIME", XS_DBI_constant, file);
        XSANY.any_i32 = SQL_DATETIME ;
        sv_setpv((SV*)cv, "") ;
        cv = newXS("DBI::SQL_ARRAY", XS_DBI_constant, file);
